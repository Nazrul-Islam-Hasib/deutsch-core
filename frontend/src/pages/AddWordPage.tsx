...
const AddWordPage: React.FC = () => {
  ...
  const { addWord, isLoading, error: apiError } = useWordStore();
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-12">
      ...
      <div className="border-b border-outline-variant/20 pb-8">
        <p className="font-headline text-[10px] tracking-[0.4em] uppercase text-secondary mb-2 cyan-glow">SYSTEM // APPEND_PROTOCOL</p>
        <h2 className="font-headline text-5xl font-black tracking-tighter text-on-surface crt-glow uppercase">NEW_DATA_ENTRY</h2>
      </div>
